...
require_once('koneksi.php');
	...
	if(!empty($_POST['nama_barang'])){
		...
		$sql = 'UPDATE tbl_barang SET nama_barang=?,stok=?,harga_barang=?,tgl_masuk=? WHERE id=?';
                ...
                <div class="col-lg-6">
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $hasil['nama_barang'];?>" class="form-control"
                                name="nama_barang">
                        </div>
                        <div class="form-group">
                            <label>Stok</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $hasil['harga_barang'];?>" class="form-control"
                                name="harga">
                        </div>
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input type="date" value="<?php echo $hasil['tgl_masuk'];?>" class="form-control"
                                name="tanggal">
                        </div>
